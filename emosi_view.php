...
<body id="body">
    ...
    <div class="dashboard">
        <div class="sidebar" id="sidebar-mobile">
            <nav>
                <ul>
                    ...
                    <li class="menu-color active" style="background-color: #8800A0;">
        ...
        <div class="mainbar" id="mainbar">
            <header class="d-flex clearfix">
                ...
                <h5 class="f-left">Halaman Emosi</h5>
            </header>
            <button class="action-add ripple-effect" onclick="modalAdd()" style="background-color: #8800A0;"><i class="material-icons">add</i></button>
    ...
    <script src="js/color_script.js"></script>
