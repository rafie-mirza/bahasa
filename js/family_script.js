...
function loadData(){
    ...
    ajax.open('POST', './php/family_controller.php?type=view', true);
    ajax.send();
}
...
document.getElementById('form-add').addEventListener("submit", function(e){
	...
	// var wordLabelAdd = document.getElementById('word-label-add').value;
	// var wordSundaAdd = document.getElementById('word-sunda-add').value;

	// console.log(imageAdd);
	// console.log(wordLabelAdd);
	// console.log(wordSundaAdd);
	...
	if(imageAdd == ''){
	    ...
	    ajax.open('POST', './php/family_controller.php?type=insert', true);
	    ajax.send(formData);
...
function modalEdit(id) {
    ...
    ajax.open('GET', './php/family_controller.php?type=getData&id=' + id, true);
    ajax.send();
...
document.getElementById('form-edit').addEventListener("submit", function(e){
	...
	if(imageEdit == '' || imageEdit == null){
        urlAjax = "./php/family_controller.php?type=edit&id=" + idEdit;
    }else{
    	urlAjax = "./php/family_controller.php?type=editWithImage&id=" + idEdit;   
    } 
...
function deleteData(){
    ...
    ajax.open('POST', './php/family_controller.php?type=delete&id=' + idDelete + '&image=' + imageDelete, true);
    ajax.send();
